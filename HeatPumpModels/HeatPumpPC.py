...
if __name__ == '__main__':
    ...
    parampath = os.path.join(
        __file__, '..', 'input', f'params_hp_pc_econ_{econ_type}.json'
        )
    ...
    hp = HeatPumpPC(params, econ_type=econ_type)

    hp.run_model(print_cop=True, print_results=True)
    hp.generate_state_diagram(open_file=True)
    # hp.calc_cost()
    ...
    # data.to_csv('hp_econ_open_4GDH.csv', sep=';')
